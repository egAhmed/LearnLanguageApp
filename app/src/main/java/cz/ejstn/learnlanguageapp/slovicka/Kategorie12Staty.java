...
public class Kategorie12Staty {
    ...
    private static ArrayList<Slovicko> vytvorSlovicka (ArrayList<Slovicko> slovicka) {
        ...
        slovicka.add(new Slovicko("United Kingdom", "Anglie",R.drawable.staty_anglie, R.raw.song));
        ...
        slovicka.add(new Slovicko("China", "Čína",R.drawable.staty_china, R.raw.song));
        ...
        slovicka.add(new Slovicko("Tunisia", "Tunis",R.drawable.staty_tunis, R.raw.song));
      ...
      //  slovicka.add(new Slovicko("Mozambique", "Mozambik",R.drawable.staty_mozambik, R.raw.song));
      ...
      //  slovicka.add(new Slovicko("Namibia", "Namíbie",R.drawable.staty_namibie, R.raw.song));
      //  slovicka.add(new Slovicko("Swaziland", "Swazijsko", R.drawable.staty_swazjisko, R.raw.song));
        slovicka.add(new Slovicko("South Africa", "Jižní Afrika", R.drawable.staty_jizni_afrika, R.raw.song));



        // SEVERNÍ AMERIKA
        slovicka.add(new Slovicko("Mexico", "Mexiko", R.drawable.smajlik, R.raw.song));
        slovicka.add(new Slovicko("USA", "Spojené Státy Americké",R.drawable.smajlik, R.raw.song));
        slovicka.add(new Slovicko("Cuba", "Kuba", R.drawable.smajlik, R.raw.song));
        slovicka.add(new Slovicko("Canada", "Kanada", R.drawable.priroda_plaz, R.raw.song));


        // JIŽNÍ AMERIKA

        slovicka.add(new Slovicko("Colombia", "Kolumbie", R.drawable.smajlik, R.raw.song));
        slovicka.add(new Slovicko("Venezuela", "Venezuela",R.drawable.smajlik, R.raw.song));
        slovicka.add(new Slovicko("Brasil", "Brazílie", R.drawable.smajlik, R.raw.song));
        slovicka.add(new Slovicko("Peru", "Peru", R.drawable.priroda_plaz, R.raw.song));

     //   slovicka.add(new Slovicko("Bolivia", "Bolívie", R.drawable.smajlik, R.raw.song));
        slovicka.add(new Slovicko("Chile", "Čile",R.drawable.smajlik, R.raw.song));
      //  slovicka.add(new Slovicko("Paraguay", "Paragvaj", R.drawable.smajlik, R.raw.song));
        slovicka.add(new Slovicko("Argentina", "Argentina", R.drawable.priroda_plaz, R.raw.song));

      //  slovicka.add(new Slovicko("Costa Rica", "Kostarika", R.drawable.smajlik, R.raw.song));
      //  slovicka.add(new Slovicko("Guatemala", "Gvatemala",R.drawable.smajlik, R.raw.song));
        slovicka.add(new Slovicko("Belize", "Belize", R.drawable.smajlik, R.raw.song));
        slovicka.add(new Slovicko("the Dominican Republic", "Dominikánská republika", R.drawable.priroda_plaz, R.raw.song));

        // AUSTRÁLIE A OCEÁNIE

        slovicka.add(new Slovicko("Australia", "Austrálie", R.drawable.smajlik, R.raw.song));
     //   slovicka.add(new Slovicko("New Zealand", "Nový Zéland",R.drawable.smajlik, R.raw.song));
