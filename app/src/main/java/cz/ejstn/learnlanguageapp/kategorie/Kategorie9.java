...
import cz.ejstn.learnlanguageapp.slovicka.Kategorie9Bydleni;
...
public class Kategorie9 extends AppCompatActivity {
    ...
    private void vsechnoPriprav() {
        ...
        final ArrayList<Slovicko> slovicka = Kategorie9Bydleni.pripravKategorii();
        SlovickaAdapter adapter = new SlovickaAdapter(this, slovicka, R.color.category_item_9);
        ...
        listSlovicek.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                prehravac = MediaPlayer.create(Kategorie9.this, slovicka.get(position).getIdZvuku());
                prehravac.start();
